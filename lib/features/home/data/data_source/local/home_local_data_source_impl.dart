...
class HomeLocalDataSourceImpl implements HomeLocalDataSource {
  ...
  Future<WeeklyForecastResponseModel> getWeeklyForecast(
    ...
    final data = await box.get(
      '${DatabaseKeys.WEEKLY}${lat}_$lon',
      defaultValue: null,
    );
    if (data != null) {
      return WeeklyForecastResponseModel.fromJson(jsonDecode(data));
    } else {
      throw CacheException(message: errorMessage);
    }
  }
  ...
  Future<void> setCurrentWeather(
    double lat,
    double lon,
    CurrentWeatherResponseModel data,
  ) async {
  ...
  Future<void> setHourlyForecast(
    double lat,
    double lon,
    HourlyForecastResponseModel data,
  ) async {
  ...
  @override
  Future<void> setWeeklyForecast(
    double lat,
    double lon,
    WeeklyForecastResponseModel data,
  ) async {
    final hourlyWeather = jsonEncode(data.toJson());
    await box.put('${DatabaseKeys.WEEKLY}${lat}_$lon', hourlyWeather);
  }
}
